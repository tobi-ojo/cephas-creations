...
const stats = [
  ...
  { num: '12+',  label: 'Years in Abeokuta'  },
    ...
    <section id="about" ref={ref} className="bg-dark-800 py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <p className="text-gold-400 text-xs font-medium tracking-[0.14em] uppercase mb-4">About Us</p>
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-cream leading-tight mb-6">
              Trusted Across<br />Abeokuta &<br />Ogun State
            </h2>
            <p className="text-cream/55 text-base leading-relaxed mb-5">
              Cephas Creations is a full-spectrum built-environment firm with over a decade of
              delivering architectural excellence, strategic property advisory, precision construction,
            ...
            <p className="text-cream/55 text-base leading-relaxed mb-8">
              ...
              and titling to architectural design, construction, and long-term estate management.
            </p>
            <div className="flex items-center gap-3">
              <div className="h-px w-10 bg-gold-600" />
              <span className="text-gold-400/70 text-xs tracking-widest uppercase italic font-serif">
          ...
          >
            {stats.map((s, i) => (
              <motion.div
                ...
                className="bg-dark-700/50 border border-gold-600/15 p-6 rounded-sm"
              >
                <div className="font-serif text-4xl font-bold text-gold-400 mb-1">{s.num}</div>
                <div className="text-cream/40 text-xs tracking-wide">{s.label}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
